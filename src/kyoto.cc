...
static std::unique_ptr<ExprAST> ParseForExpr() {
  ...
  return llvm::make_unique<ForExprAST>(IdName,
                                       std::move(Start),
                                       std::move(End),
                                       std::move(Step),
                                       std::move(Body));
...
static std::unique_ptr<PrototypeAST> ParsePrototype() {
  ...
  return llvm::make_unique<PrototypeAST>(
...
static std::unique_ptr<KyotoJIT> TheJIT;
...
int main() {
  ...
  TheJIT = llvm::make_unique<KyotoJIT>();
